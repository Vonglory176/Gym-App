...
import { SectionWrapperProps } from '../utils/types'
...
const SectionWrapper: React.FC<SectionWrapperProps> = ({ children, header, title, id }) => {

  return (
    <section className='min-h-screen flex flex-col gap-10 pb-10' id={id}>
