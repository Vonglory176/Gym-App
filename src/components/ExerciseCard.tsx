...
import { ExerciseCardProps } from '../utils/types'
    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
                ...
                <button onClick={handleSetIncrement} className="flex flex-col p-2 rounded border border-[1.5px] border-solid border-blue-900 hover:border-blue-600 w-full duration-200">
